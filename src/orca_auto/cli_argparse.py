...
bypassing :mod:`orca_auto.cli_errors`. This subclass funnels those errors
through :func:`orca_auto.cli_errors.emit_error` so every user-facing failure —
...
__all__ = ["OrcaAutoArgumentParser"]
