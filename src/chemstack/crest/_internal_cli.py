...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="python -m chemstack.crest._internal_cli")
    parser.add_argument("--config", default=default_config_path(), help="Path to chemstack.yaml containing CREST settings")
    sub = parser.add_subparsers(dest="command", required=True)

    scaffold = sub.add_parser("scaffold", help="Create an internal CREST job scaffold")
    ...
    organize = sub.add_parser("organize", help="Plan or apply CREST job organization")
