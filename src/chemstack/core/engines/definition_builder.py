...
from chemstack.core.queue.child_execution import build_queue_entry_lookup
...
def build_lazy_queue_worker_runner(module_name: str, function_name: str = "main") -> QueueWorkerRunner:
...
def _default_dequeue_next(root: Path) -> Any | None:
    from chemstack.core.queue import dequeue_next
